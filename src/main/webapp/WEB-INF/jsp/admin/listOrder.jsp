	...
	$("button.orderPageCheckOrderItems").click(function(){
		...
		$.ajax({
			...
			success:function(data){
				$("table.orderPageOrderItemTable").empty();
				for(var i=0;i<data.length;i++){
					var oi = data[i];
					$("table.orderPageOrderItemTable").append("<tr><td align=\"left\"><img width=\"40px\" height=\"40px\" src=\"${pageContext.request.contextPath}/img/productSingle_middle/673.jpg\"></td><td><a href=\"foreproduct?pid="+oi.pid+"\"><span>"+oi.name+"</span></a></td><td align=\"right\"><span class=\"text-muted\">"+oi.number+"个</span></td><td align=\"right\"><span class=\"text-muted\">单价：￥"+oi.promotePrice+"</span></td></tr>");
				}
